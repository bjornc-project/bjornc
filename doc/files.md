...
* bjornc.conf: contains configuration settings for bjorncd or bjornc-qt
* bjorncd.pid: stores the process id of bjorncd while running
...
* debug.log: contains debug information and general logging generated by bjorncd or bjornc-qt
