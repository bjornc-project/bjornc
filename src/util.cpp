...
const char * const BITCOIN_CONF_FILENAME = "bjornc.conf";
const char * const BITCOIN_PID_FILENAME = "bjorncd.pid";
...
#ifdef WIN32
    // Windows
    return GetSpecialFolderPath(CSIDL_APPDATA) / "Bjornc";
#else
    fs::path pathRet;
...
#ifdef MAC_OSX
    // Mac
    return pathRet / "Library/Application Support/Bjornc";
#else
    // Unix
    return pathRet / ".bjornc";
#endif
#endif
}
