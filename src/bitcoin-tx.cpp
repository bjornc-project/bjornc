...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s bjornc-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  bjornc-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded bjornc transaction") + "\n" +
              "  bjornc-tx [options] -create [commands]   " + _("Create hex-encoded bjornc transaction") + "\n" +
              "\n";
